...
penguins.f <- filter(penguins, sex == "female", species == "Adelie")

ggpubr::ggqqplot(
  data = penguins.f,    #put the data frame name here 
  "body_mass_g",         #put the continuous variable name here
  color = "species")  #put the categorical variable here
...
Feel free to replace the hex codes with other color-blind friendly color options.
