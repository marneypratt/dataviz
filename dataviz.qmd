...
waterQ2 |>                        #name of the data frame is here
  ...
  summarize(mean = mean(___),     #put the water quality variable name here
            median = median(___), #put the water quality variable name here
            SD = sd(___),         #put the water quality variable name here
            IQR = IQR(___),       #put the water quality variable name here
...
## Render this File to HTML then Pring to PDF
