...
-   Make sure the HTML file is saved somewhere on your computer that you can get to (as with the graph file above, you will first need to export this file to your computer if you are working on the Smith server)

-   Place a copy of the HTML file in your Individual Google Drive folder for this class
