...
-   Render this Quarto file to PDF using the typst format (just select the Render menu item at the top of this window)

-   If the file didn't already open, then double click on the name of the file in the Files window

-   Please name your PDF file "dataviz_YourName.pdf" (replace "YourName" with your full name)
