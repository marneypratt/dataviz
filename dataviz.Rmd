...
Let's remove the NA's for your variable. Run the code below making sure to replace the blank below with the name of your variable of interest.
...
Next let's calculate the descriptive statistics for your variable of interest for the Mill River water quality data. Run the code below making sure to replace the blanks below with the name of your variable of interest.
...
#Histogram  
ggplot(data = waterQ2, 
       aes(x = ____, fill=location)) + #place the variable name in the blank after x=
...
Note that when you make a histogram you are only looking at one variable at a time and because it is easier to look at, we place that variable on the x-axis (and count will be on the y-axis). This same variable may be better placed on the y-axis when making other types of graphs.
