...
#Histogram for Flow 
ggplot(data = waterQ2, aes(x = flow, fill=location))+ 
...
#Histogram for DO
ggplot(data = waterQ2, aes(x = DO, fill=location))+ 
...
#Histogram for Light
ggplot(data = waterQ2, aes(x = light, fill=location))+ 
...
ggplot(data = waterQ2, aes(x = turb, fill=location))+ 
...
ggplot(data = waterQ2, aes(x = cond, fill=location))+ 
