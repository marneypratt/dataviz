...
#Histogram for Flow 
ggplot(data = waterQ2.f, aes(x = flow, fill=location))+ 
...
#Histogram for DO
ggplot(data = waterQ2.do, aes(x = DO, fill=location))+ 
...
#Histogram for Light
ggplot(data = waterQ2.l, aes(x = light, fill=location))+ 
...
#Histogram for pH
ggplot(data = waterQ2.ph, aes(x = pH, fill=location))+ 
  geom_histogram(binwidth = 0.05, color = "white", show.legend = FALSE) +
  facet_grid(location ~ .) +
  xlab("pH") +
  ylab("Count") +
...
ggplot(data = waterQ2.wt, aes(x = wTemp, fill=location))+ 
...
ggplot(data = waterQ2.t, aes(x = turb, fill=location))+ 
...
ggplot(data = waterQ2.c, aes(x = cond, fill=location))+ 
