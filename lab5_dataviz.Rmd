...
Note that you must save a script and then type submit() in the console to run the script code for Swirl to know you have run the script.

See the "swirl-commands.txt" and "swirl-tips.txt" files for more help with Swirl
