...
**Question: What do you predict to see in the data comparing the upstream and downstream locations for this variable? (in other words, How do you predict Paradise Pond will affect this variable (if at all)?).  Write your answer below:**





**Question: Why did you make the prediction above?  Explain your answer below:**
...
Have one person from your group run the code below to start Swirl, then work in the console to run through the "Descriptive Statistics" lesson.  Go through the lesson together as a group.  When you finish the lesson, exit Swirl.
...
**Question: Give the rounded values for SD (use 2 signifiacnt digits) for each group below:**
